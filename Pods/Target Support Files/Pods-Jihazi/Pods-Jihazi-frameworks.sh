...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AlgoliaSearch-Client/AlgoliaSearch_Client.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/StartSDK/StartSDK.framework"
